			...
			<form action="http://localhost/college/index.php?mod=student&view=studentUpdate" method="POST"
				...
				<div class="forminside">
					<div class="id">
						...
						<input id="studentId" type="text" name="student_id"
							value="<?php echo "{$quer[0]['student_id']}" ?>" required readonly>
					</div>
					<div class="fname">
						<label for="first_name">First Name</label>
						<input id="first_name" type="text" name="first_name"
							value="<?php echo "{$quer[0]['first_name']}" ?>" required><br><br>
					</div>
					<div class="lname">
						<label for="last_name">Last Name</label>
						<input id="last_name" type="text" name="last_name"
							value="<?php echo "{$quer[0]['last_name']}" ?>" required><br><br>
					</div>
					<div class="dept">
						<label for="department">Department</label>
						<input id="department" type="text" name="department"
							value="<?php echo "{$quer[0]['department']}" ?>" required><br><br>
					</div>
					<div class="email">
					...
					<div class="phone">
						...
						<input id="phone" type="tel" name="phone" value="<?php echo "{$quer[0]['phone']}" ?>" required>
						<br><br>
					</div>
					<div class="dob">
					...
					<div class="blood_grp">
						...
						<select name="blood_group" id="blood_group" class="selectData">
							...
							<option value="A NEGATIVE" <?php if ($quer[0]['blood_group'] == 'A NEGATIVE')
								echo 'selected'; ?>>A NEGATIVE (A-)</option>
							<option value="B POSITIVE" <?php if ($quer[0]['blood_group'] == 'B POSITIVE')
								echo 'selected'; ?>>B POSITIVE (B+)</option>
							<option value="B NEGATIVE" <?php if ($quer[0]['blood_group'] == 'B NEGATIVE')
								echo 'selected'; ?>>B NEGATIVE (B-)</option>
							<option value="O POSITIVE" <?php if ($quer[0]['blood_group'] == 'O POSITIVE')
								echo 'selected'; ?>>O POSITIVE (O+)</option>
							<option value="O NEGATIVE" <?php if ($quer[0]['blood_group'] == 'O NEGATIVE')
								echo 'selected'; ?>>O NEGATIVE (O-)</option>
							<option value="AB POSITIVE" <?php if ($quer[0]['blood_group'] == 'AB POSITIVE')
								echo 'selected'; ?>>AB POSITIVE (AB+)</option>
							<option value="AB NEGATIVE" <?php if ($quer[0]['blood_group'] == 'AB NEGATIVE')
								echo 'selected'; ?>>AB NEGATIVE (AB-)</option>
						</select><br><br>
					</div>
